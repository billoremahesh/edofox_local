<div id="add_chapter_modal" class="modal fade" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <?php echo form_open('chapters/add_chapter_submit'); ?>
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <input type="text" class="form-control" name="chapter_name" id="chapter_name" maxlength="120" required>
                    </div>
                </div>
...
<script>
    ...
    $('.subject_dropdown').select2({
        width: "100%",
        dropdownParent: $("#add_chapter_modal")
    });
</script>