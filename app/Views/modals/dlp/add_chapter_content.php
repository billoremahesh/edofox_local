    ...
    <div id="addNewCourseResource" class="modal fade" role="dialog">
        <div class="modal-dialog modal-lg">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row" id="resource-type-div">
                        <div class="col-md-4">
                            <div class="mb-2">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <img class="loading-div" id="course-loading-div" src="<?= base_url('assets/img/loading.gif'); ?>" />
                            <div class="form-group" id="tests-dropdown-div" style="display: none;"></div>
                        </div>
                    </div>
                    ...
                    <div class="row" id="video-data-div" style="display: none;">
                        ...
                        <div class="col-md-8">
                            <div class="mb-2">
                                <label class="form-label" for="video_file">Upload Video File</label>
                ...
                <div class="modal-footer">
                    <input type="hidden" name='redirect_to_content_page' value="true" />
                    <input type="hidden" name="institute_id" value="<?= decrypt_cipher($instituteID); ?>" required />
                    <input type="hidden" name='classrooms[]' id='add_classroom_id' value="<?= $classroom_id; ?>" />
                    <input type="hidden" name='subject_id' id="add_subject_id" value="<?= $subject_id; ?>" />
                    <input type="hidden" name='chapter_id' id='chapter_id_input' value="<?= $chapter_id; ?>" />
    ...
    <script>
        ...
        $('.course_tests_dropdown').select2({
            ...
            width: '100%',
            dropdownParent: $("#addNewCourseResource")
        });
