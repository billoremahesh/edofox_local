<div id="signup_link" class="modal fade" role="dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="d-flex align-content-start flex-wrap text-break" id="shareSignupLink">
                    <?php if ($classroom_id != "") :
                        echo  base_url("/registration/signup/" . $instituteID);
                    else :
                        echo base_url("/registration/signup/" . $instituteID . "/" . $classroom_id);
                    endif;
                    ?>
                </div>
            </div>
