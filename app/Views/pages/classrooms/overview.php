            ...
            <div class="d-flex justify-content-between my-1">
                ...
                <div class="d-flex flex-row-reverse">
                    ...
                    <?php if (in_array("manage_classrooms", session()->get('perms')) or in_array("all_perms", session()->get('perms'))) :  ?>
                        <a href="#" onclick="show_add_modal('modal_div','add_classroom_modal','classrooms/add_classroom_modal/classrooms');" data-toggle='tooltip' title='Add New Classroom'>
...
<script>
    ...
    $(document).ready(function() {
        classroomsListTable = $('#classroomsListTable').DataTable({
            ...
            "serverSide": true,
            "ajax": {
                'url': base_url + "/classrooms/load_classrooms",
                "type": "POST",
                "data": function(d) {
            ...
            'drawCallback': function(data) {
                ...
                $('#total_classrooms').html("Total Classrooms: " + data.json.recordsFiltered);
                initializeTooltip();
            },
            "dataSrc": "Data",
