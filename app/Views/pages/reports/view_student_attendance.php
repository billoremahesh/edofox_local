...
<div id="content">
    <div class="container-fluid mt-4">
        ...
        <div class="bg-white rounded shadow p-2 my-4" style="max-width: 800px;margin:auto;display:none;"> 
                <div class="text-center"><b>Session : schedule title</b></div> 
                <div><b>Month: </b></div>
                <div>Classroom: </div>
                <div>Subject: </div> 
    ...
    function format_attendance_data(data) {
        ...
        if (data != null) {
            ...
            $.each(data, function(objIndex, obj) {
                ...
                html = html + "<span style='position: absolute;right: 45%;bottom:2px;' >Total Session:10</span>";
                html = html + "<span style='position: absolute;right: 25%;bottom:2px;' >Total Classes:70</span>";
                html = html + "<span style='position: absolute;right: 5%;bottom:2px;'>Attendign Per:55%</span>";
                html = html + "</div>";
