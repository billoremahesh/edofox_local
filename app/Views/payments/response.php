...
<body>
    ...
    <!-- Custom styles -->
    <link href="<?php echo base_url('assets/css/payment_success.css'); ?>" rel="stylesheet">
...
C131.967,94.755,132.296,93.271,131.583,92.152z" />
        ...
        <div id='lower-side'>
            <p id='message' class="text-left">You will get TAX INVOICE details through mail and SMS soon.</p>
            <a href="<?php echo base_url('login'); ?>" id="contBtn">Continue to login</a>
        </div>
    </div>
