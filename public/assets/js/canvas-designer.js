                   ...
                   /* var selector = new FileSelector();
                    ...
                    // var reader = new FileReader();
                     //   reader.onload = function(event) {
                            ...
                            image.src = 'https://web-dev.imgix.net/image/tcFciHGuF3MxnTr1y5ue01OGLBn2/8J6A0Bk5YXdvyoj8HVzs.png';//event.target.result;
                      };
                        reader.readAsDataURL(file);
                   // });

                 */
                  var url = prompt('Enter URL');//'https://web-dev.imgix.net/image/tcFciHGuF3MxnTr1y5ue01OGLBn2/8J6A0Bk5YXdvyoj8HVzs.png';
                   ...
                   xhr.onload = function() {
                     ...
                     reader.onloadend = function() {
                        var image = new Image();
                            ...
                            image.style = 'position: absolute; top: -99999999999; left: -999999999;visibility: hidden;'
                            document.body.appendChild(image);
